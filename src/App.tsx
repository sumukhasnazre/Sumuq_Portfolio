...
export default function App() {
  ...
  return (
    <div
      className={`min-h-screen font-sans selection:bg-blue-500/30 transition-colors duration-500 ${
        theme === "dark"
      ...
      {!showSplash && (
        ...
        >
          ...
          <nav className="fixed top-0 w-full z-50 px-6 py-6 border-b border-transparent">
            <div
              className={`container mx-auto flex justify-between items-center backdrop-blur-xl border rounded-2xl px-6 py-3 transition-all ${
                theme === "dark"
            ...
            >
              <span
                className={`text-xl font-bold tracking-tighter ${theme === "dark" ? "text-white" : "text-slate-900"}`}
              >
                SN.
              </span>
              <div
                className={`hidden md:flex gap-8 text-sm font-medium ${theme === "dark" ? "text-slate-400" : "text-slate-500"}`}
              >
                <a
                  href="#experience"
              ...
              <div className="flex gap-4 items-center">
                ...
                <a
                  ...
                  className={`${theme === "dark" ? "text-slate-400 hover:text-white" : "text-slate-500 hover:text-black"} transition-colors`}
                >
                ...
                {resumeData.top_achievements.map((item, i) => (
                  <div key={i} className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <div className="text-blue-500 text-xs font-mono mb-1">
                        {item.metric}
                      </div>
                      <div
                        className={`${theme === "dark" ? "text-slate-400" : "text-slate-500"} text-sm leading-relaxed`}
                      >
                        {item.description}
                      </div>
                    </div>
          ...
          >
            <div className="container mx-auto px-6">
              <div className="mb-16">
                <h2
                  className={`text-3xl font-bold tracking-tight mb-4 text-center ${theme === "dark" ? "text-white" : "text-slate-900"}`}
                >
                  Tech Forge
                </h2>
                ...
                {resumeData.projects.map((project, i) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-6">
                      <div
                        className={`h-12 w-12 rounded-xl flex items-center justify-center text-blue-500 ${theme === "dark" ? "bg-slate-800" : "bg-slate-100"}`}
                      >
                    ...
                    <ul className="space-y-3">
                      {project.bullets.map((b, k) => (
                        <li
                          key={k}
                          className={`text-sm leading-relaxed ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}
                        >
                          {b}
                        </li>
                      ))}
          ...
          <section id="skills" className="py-24">
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16">
              <div>
                <h2
                  className={`text-2xl font-bold mb-8 flex items-center gap-3 ${theme === "dark" ? "text-white" : "text-slate-900"}`}
                >
              ...
              <div>
                ...
                {resumeData.education.map((edu, i) => (
                  ...
                  >
                    ...
                    <p
                      className={`text-sm mt-3 ${theme === "dark" ? "text-slate-500" : "text-slate-500"}`}
                    >
                      {edu.dates}
                    </p>
                  </div>
                ...
                <h2
                  className={`text-2xl font-bold mb-8 mt-16 flex items-center gap-3 ${theme === "dark" ? "text-white" : "text-slate-900"}`}
                >
                ...
                <div className="flex flex-wrap gap-3">
                  {Object.entries(resumeData.skills)
                    ...
                    .map((skill, i) => (
                      <span
                        key={i}
                        className={`px-4 py-2 rounded-lg border text-sm transition-all cursor-default ${
                          theme === "dark"
                ...
                <a
                  ...
                  className={`p-4 rounded-2xl border transition-all ${
                    theme === "dark"
                      ...
                      : "bg-white hover:bg-slate-50 text-slate-900 border-black/10 shadow-sm"
                  }`}
                >
